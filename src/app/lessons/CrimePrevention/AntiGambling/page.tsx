  ...
  const AntiGamblingSlides: SlideProps[] = [
    {
      ...
      image: "/LearnImage/Gambling1.png",
    ...
    {
      id: "legal-vs-illegal",
      image: "/LearnImage/Gambling2.png",
    ...
    {
      id: "addiction-signs",
      image: "/LearnImage/Gambling3.png",
    ...
    {
      id: "help-resources",
      image: "/LearnImage/Gambling4.png",
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 pt-6 flex flex-col items-center">
          ...
          <div className="w-full text-center mb-2">
            ...
            <p className="text-gray-600">Learn about the risks of gambling and how to avoid them</p>
          </div>
        </div>
