  ...
  const handleFinishModule = async (moduleId: string) => {
    try {
      ...
      const badge = await completeModule({ 
        moduleId: MODULE_ID, 
        moduleName: "Illegal Firearms and Awareness Module" 
      });
    ...
    <>
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 pt-6 flex flex-col items-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Illegal Firearms Awareness</h2>
        <h2 className="text-2xl font-bold text-gray-800"></h2>
            <p className="text-gray-600">Understand the dangers and laws around illegal firearms.</p>
          </div>
        </div>
          ...
          <div className="w-full max-w-6xl bg-white rounded-2xl shadow-lg p-4 md:p-0 overflow-hidden">
            {isClient && (
              <CarouselComponent 
                ...
                finishButtonText="Complete Illegal Firearms Awareness Module"
...
export default IllegalFirearmsAwareness;