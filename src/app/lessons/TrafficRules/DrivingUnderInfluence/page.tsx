...
const DrivingUnderInfluence: React.FC = () => {
...
const MODULE_ID = "driving-under-influence";

// Define the slides for Anti-Carnapping content
const DrivingUnderInfluenceSlides: SlideProps[] = [
    {
        id: "strong-passwords",
...
const handleFinishModule = async (moduleId: string) => {
    ...
    const badge = await completeModule({ 
        moduleId: MODULE_ID, 
        moduleName: "Driving Under Influence Lesson" 
    });
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="w-full p-4 mb-2">
            ...
            <SpeechBubble
                ...
                messages={["Drive Sober, Stay Safe", "Enjoy Reading!"]}
            />
            </div>
        </div>
        ...
        <div className="w-full text-center mb-2">
            <h2 className="text-2xl font-bold text-gray-800">Driving Under Influence</h2>
            <p className="text-gray-600">Understand the dangers of driving under the influence and how to prevent it for safer roads.</p>
        </div>
        </div>
        ...
        <div className="w-full max-w-6xl bg-white rounded-2xl shadow-lg p-4 md:p-0 overflow-hidden">
            {isClient && (
            <CarouselComponent 
                slides={DrivingUnderInfluenceSlides}
                themeColor="blue"
                completedModules={completedModules} 
                onModuleComplete={handleFinishModule} 
                finishButtonText="Complete Driving Under Influencen Module"
...
export default DrivingUnderInfluence;