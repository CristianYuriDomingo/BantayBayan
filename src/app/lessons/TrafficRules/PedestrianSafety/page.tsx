...
const PedestrianSafety: React.FC = () => {
...
const MODULE_ID = "pedestrian-safety";

// Define the slides for Anti-Carnapping content
const PedestrianSafetySlides: SlideProps[] = [
    {
        id: "strong-passwords",
...
const handleFinishModule = async (moduleId: string) => {
    ...
    const badge = await completeModule({ 
        moduleId: MODULE_ID, 
        moduleName: "Pedestrian Safety Lesson" 
    });
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="w-full p-4 mb-2">
            ...
            <SpeechBubble
                ...
                messages={["Walk Safely, Stay Alert", "Enjoy Reading!"]}
            />
            </div>
        </div>
        ...
        <div className="w-full text-center mb-2">
            <h2 className="text-2xl font-bold text-gray-800">Pedestrian Safety</h2>
            <p className="text-gray-600">Learn essential tips to stay safe while walking and crossing streets.</p>
        </div>
        </div>
        ...
        <div className="w-full max-w-6xl bg-white rounded-2xl shadow-lg p-4 md:p-0 overflow-hidden">
            {isClient && (
            <CarouselComponent 
                slides={PedestrianSafetySlides}
                themeColor="blue"
                completedModules={completedModules} 
                onModuleComplete={handleFinishModule} 
                finishButtonText="Complete Pedestrian Safety Module"
