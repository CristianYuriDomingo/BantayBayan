    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="w-full p-4 mb-2">
            ...
            <SpeechBubble
                ...
                messages={["Plan Ahead, Stay Safe", "Enjoy Reading!"]}
            />
            </div>
        </div>
        ...
        <div className="w-full text-center mb-2">
            <h2 className="text-2xl font-bold text-gray-800">Evacuation Procedure</h2>
            <p className="text-gray-600">Learn the steps to safely evacuate during emergencies and protect yourself and your loved ones.</p>
        </div>
        </div>
