...
const MODULE_ID = "cybersecurity-data-protection";
...
const handleFinishModule = async (moduleId: string) => {
    ...
    const badge = await completeModule({ 
        moduleId: MODULE_ID, 
        moduleName: "Cybersecurity and Data Protection Module" 
    });
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="w-full p-4 mb-2">
            ...
            <SpeechBubble
                ...
                messages={["Practice Drills, Stay Safe", "Enjoy Reading!"]}
            />
            </div>
        </div>
        ...
        <div className="w-full text-center mb-2">
            <h2 className="text-2xl font-bold text-gray-800">Fire and Earthquake Drills</h2>
            <p className="text-gray-600">Learn the importance of fire and earthquake drills to ensure safety during emergencies.</p>
        </div>
        </div>
        ...
        <div className="w-full max-w-6xl bg-white rounded-2xl shadow-lg p-4 md:p-0 overflow-hidden">
            {isClient && (
            <CarouselComponent 
                slides={CybersecurityDataProtectionSlides}
                themeColor="blue"
                completedModules={completedModules} 
                onModuleComplete={handleFinishModule} 
                finishButtonText="Complete Cybersecurity and Data Protection Module"
