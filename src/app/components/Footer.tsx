...
const Footer = () => {
  return (
    <section className="mt-40">
      <footer className="bg-gray-900 text-white py-10 px-4 md:px-8 lg:px-16 2xl:px-60">
      ...
      <div className="bg-gray-900 text-center py-6 px-4 md:px-8 lg:px-16 2xl:px-60">
