...
export default function RecommendedNext() {
  ...
  const allModules: Module[] = [
    ...
    // Traffic Rules
    { id: 'basic-traffic', title: 'Basic Traffic Rules', category: 'Traffic Rules', path: '/lessons/TrafficRules/BasicTrafficRules' },
    { id: 'road-safety', title: 'Road Safety Tips', category: 'Traffic Rules', path: '/lessons/TrafficRules/RoadSafetyTips' },
